...
from med_assert.application.dedup.service import DedupReport
...
DEFAULT_API_OUTPUT_SUBDIR = Path("med_assert_output")
...
class CollectRequest(BaseModel):
    ...
    tool: str = Field("med_assert", min_length=1, description="Tool name sent to NCBI.")
...
DEDUP_OPENAPI_EXAMPLES: dict[str, dict[str, Any]] = {
    "specter_faiss": {
        ...
        "value": {
            "collection_path": "med_assert_output/collect.json",
