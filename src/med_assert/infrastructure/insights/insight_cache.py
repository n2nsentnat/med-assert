...
from med_assert.infrastructure.insights.canonical_text import build_canonical_text
from med_assert.infrastructure.insights.prompts import PROMPT_VERSION
