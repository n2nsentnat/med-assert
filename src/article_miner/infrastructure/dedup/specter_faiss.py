...
DEFAULT_SPECTER_MODEL = os.environ.get(
    "ARTICLE_MINER_SPECTER_MODEL", "allenai/specter2_base"
)

# Cosine similarity threshold (embeddings are L2-normalized; inner product = cosine).
DEFAULT_SPECTER_SIM_THRESHOLD = float(os.environ.get("ARTICLE_MINER_SPECTER_THRESHOLD", "0.92"))

# Neighbors to inspect per article (CPU FAISS flat index).
DEFAULT_SPECTER_FAISS_K = int(os.environ.get("ARTICLE_MINER_SPECTER_K", "32"))
    ...
    *,
    ...
    try:
        ...
        msg = (
            ...
            "pip install 'article-miner[specter]'"
        )
